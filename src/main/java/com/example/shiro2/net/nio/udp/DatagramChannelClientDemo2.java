package com.example.shiro2.net.nio.udp;
...
public class DatagramChannelClientDemo2 {
    ...
    public DatagramChannelClientDemo2() throws IOException {
        try {
    ...
    public static void main(String[] args) throws IOException {
        new Thread(new Runnable() {
            public void run() {
                try {
                    new DatagramChannelClientDemo2().service();
                } catch (IOException e) {
                    e.printStackTrace();
                }
            }
